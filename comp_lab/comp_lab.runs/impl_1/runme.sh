...
HD_PWD='D:/Learning_Vivado/comp_lab/comp_lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sub2b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sub2b.tcl -notrace
