...
HD_PWD='/home/npl/Learning_Vivado/seq_lab/seq_lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sel_case.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sel_case.tcl
